...
data_one_hot.drop(data_one_hot.columns[[0]], axis=1, inplace=True)  # удаляем первый столбец DataFrame

print(data_one_hot.head(20))  # выводим результат, результат совпал - задача решена
